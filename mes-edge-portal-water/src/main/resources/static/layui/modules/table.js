...
layui.define(['lay', 'laytpl', 'laypage', 'form', 'util'], function (exports) {
    ...
    Class.prototype.renderAvg = function (data, avgRowData) {
        ...
        that.eachCols(function (i3, item3) {
            ...
            var thisAvgNum = avgNums[field]
                ? parseFloat(avgNums[field] || 0).toFixed(decimals)
                : '';
            ...
            var tdContent = function () {
                ...
                if (typeof totalRow === 'string') {
                    return laytpl(totalRow).render($.extend({
                        AVG_NUMS: AVG_NUMS || avgNums[field],
                        AVG_ROW: avgRowData || {},
                        LAY_COL: item3
                    }, item3));
                }
    ...
    Class.prototype.renderMin = function (data, minRowData) {
        ...
        that.eachCols(function (i3, item3) {
            ...
            var thisMinNum = minNums[field]
                ? parseFloat(minNums[field] || 0).toFixed(decimals)
                : '';
            ...
            var tdContent = function () {
                ...
                if (typeof totalRow === 'string') {
                    return laytpl(totalRow).render($.extend({
                        MIN_NUMS: MIN_NUMS || minNums[field],
                        MIN_ROW: minRowData || {},
                        LAY_COL: item3
                    }, item3));
                }
    ...
    Class.prototype.renderMax = function (data, maxRowData) {
        ...
        that.eachCols(function (i3, item3) {
            ...
            var thisMaxNum = maxNums[field]
                ? parseFloat(maxNums[field] || 0).toFixed(decimals)
                : '';
            ...
            var tdContent = function () {
                ...
                if (typeof totalRow === 'string') {
                    return laytpl(totalRow).render($.extend({
                        MAX_NUMS: MAX_NUMS || maxNums[field],
                        MIN_ROW: maxRowData || {},
                        LAY_COL: item3
                    }, item3));
                }
