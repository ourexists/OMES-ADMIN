...
import { fetchDevgPage } from '@/api/devg'
...
const columns = computed(() => [
  { title: t('moPage.devgName'), dataIndex: 'name', key: 'name', ellipsis: true },
  { title: t('moPage.devgCode'), dataIndex: 'selfCode', key: 'selfCode', width: 160, align: 'center' as const },
...
function onSelect(record: DevgRecord) {
  emit('select', record)
        ...
        >
          <template #bodyCell="{ column, record }">
            <template v-if="column.key === 'action'">
              <a-button type="link" size="small" @click="onSelect(record as DevgRecord)">
                <CheckOutlined />
