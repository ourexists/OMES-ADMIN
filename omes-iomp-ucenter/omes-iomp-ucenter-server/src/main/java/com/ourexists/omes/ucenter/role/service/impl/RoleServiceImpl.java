 ...
 */
package com.ourexists.omes.ucenter.role.service.impl;
...
import com.ourexists.omes.ucenter.role.RolePageQuery;
import com.ourexists.omes.ucenter.role.mapper.RoleMapper;
import com.ourexists.omes.ucenter.role.pojo.Role;
import com.ourexists.omes.ucenter.role.service.AccRoleService;
...
//                .eq(pageQuery.getType() != null, Role::getType, pageQuery.getType())
                .like(StringUtils.hasText(pageQuery.getCode()), Role::getCode, pageQuery.getCode())
