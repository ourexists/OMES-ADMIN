...
@Service
public class EquipRunRecordServiceImpl extends AbstractMyBatisPlusService<EquipRunRecordMapper, EquipRunRecord>
        implements EquipRunRecordService {
    ...
    public Page<EquipRunRecord> selectByPage(EquipRunRecordPageQuery dto) {
        LambdaQueryWrapper<EquipRunRecord> qw = new LambdaQueryWrapper<EquipRunRecord>()
                .ge(dto.getRunStartTimeStart() != null, EquipRunRecord::getRunStartTime, dto.getRunStartTimeStart())
                .le(dto.getRunEndTimeEnd() != null, EquipRunRecord::getRunEndTime, dto.getRunEndTimeEnd())
                .orderByDesc(EquipRunRecord::getId);
