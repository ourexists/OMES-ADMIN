...
package com.ourexists.omes.mps.feign;
...
//    @GetMapping("startTf")
    ...
    JsonResponseEntity<List<MPSDto>> selectByMoCode(@RequestParam String moCode);

    JsonResponseEntity<List<MPSDto>> voidMpsCascade(@RequestBody List<String> ids,
                                                    @RequestParam(required = false, defaultValue = "false") Boolean forceExecing);

    JsonResponseEntity<Boolean> updateExecTime(@RequestBody List<String> ids, @RequestParam java.util.Date execTime);

    JsonResponseEntity<Boolean> rebindDev(@RequestParam String mpsId,
