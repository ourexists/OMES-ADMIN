...
package com.ourexists.omes.mo.feign;
...
//    @PostMapping("delete")
    ...
    JsonResponseEntity<Boolean> updateStatus(@RequestBody List<String> moCodes, @RequestParam MOStatusEnum status);

    JsonResponseEntity<Boolean> updateExecTime(@RequestParam String selfCode, @RequestParam Date execTime);

    JsonResponseEntity<Boolean> updateLineCode(@RequestParam String selfCode, @RequestParam String lineCode);

    JsonResponseEntity<Boolean> updateNumAndSurplus(@RequestParam String selfCode,
                                                    @RequestParam Integer num,
                                                    @RequestParam Integer surplus);

    JsonResponseEntity<MoAdjustLogDto> saveAdjustLog(@RequestBody MoAdjustLogDto dto);

    JsonResponseEntity<MoAdjustLogDto> updateAdjustLog(@RequestBody MoAdjustLogDto dto);

    JsonResponseEntity<MoAdjustLogDto> selectAdjustLogByRequestId(@RequestParam String requestId);

    JsonResponseEntity<List<MoAdjustLogDto>> selectAdjustLogsByMoCode(@RequestParam String moCode);
}
